  ...
  (function () {
    var PUP = {
        ...
        vendors: {
            ...
            XF2: {
                ...
                settings: {
                    ...
                    html:
                        ' <a %x class="%bClass button button--link button button--icon button--icon--upload"><span class="button-text">%text</span></a> ',
        ...
        init: function () {
            ...
            if (document.head.getAttribute("data-chevereto-addUploadHandler") != 1) {
                window.addEventListener("message", uploadHandler, !1);
                document.head.setAttribute("data-chevereto-addUploadHandler", 1)
            }
